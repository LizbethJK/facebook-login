                ...
                if (!TextUtils.isEmpty(user) && !TextUtils.isEmpty(pass)) {
                    if (!TextUtils.isEmpty(edUsuario.getText()) && !TextUtils.isEmpty(edPass.getText())) {
                        if (user.contentEquals(edUsuario.getText()) && pass.contentEquals(edPass.getText())) {
                            Toast.makeText(getApplicationContext(), "USUARIO CORRECTO!!! " + nombre, Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(getApplicationContext(), "NECESITAS UN USUARIO Y CONSTRESEÑA", Toast.LENGTH_LONG).show();
                        Log.e("no digitado", "no digitado");
                    }
                } else {
                    Toast.makeText(getApplicationContext(), "REGISTRATE PRIMERO", Toast.LENGTH_LONG).show();
